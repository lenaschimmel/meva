...
public class Meva {
	...
	public static PrintWriter commentPw;
	...
	public static void main(String[] args) throws IOException {
		...
		try {
            File commentFile = new File(args[0] + "/../../tables.sql").getCanonicalFile();
            commentPw = new PrintWriter(commentFile); 
            commentPw.println("/* Generated by Meva at " + new Date() + " */");
            commentPw.println("CREATE TABLE IF NOT EXISTS `MaxId` (");
            commentPw.println("        `maxId` BIGINT NOT NULL,");
            commentPw.println("        `typeName` varchar(240),");
            commentPw.println("        PRIMARY KEY (`typeName`)");
            commentPw.println("    ) ENGINE=MyISAM DEFAULT CHARSET=utf8;");
        } catch (IOException e) {
            e.printStackTrace();
        }
