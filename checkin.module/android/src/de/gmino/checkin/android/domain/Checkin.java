...
public class Checkin extends CheckinGen {
	...
	public Checkin(long id, boolean ready, Timestamp timestamp, Consumer consumer, Shop shop) {
		super(id, ready, (de.gmino.geobase.android.domain.Timestamp) timestamp, (de.gmino.checkin.android.domain.Consumer) consumer, (de.gmino.checkin.android.domain.Shop) shop);
	}
