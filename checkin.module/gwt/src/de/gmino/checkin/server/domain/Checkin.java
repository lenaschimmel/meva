...
public class Checkin extends CheckinGen {
	...
	public Checkin(long id, boolean ready, Timestamp timestamp, Consumer consumer, Shop shop) {
		super(id, ready, (de.gmino.geobase.server.domain.Timestamp) timestamp, (de.gmino.checkin.server.domain.Consumer) consumer, (de.gmino.checkin.server.domain.Shop) shop);
	}
