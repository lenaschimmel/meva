...
public class Coupon extends CouponGen {
	...
	public Coupon(long id, boolean ready, Shop shop, String title, String description, ImageUrl image, Duration duration) {
		super(id, ready, (de.gmino.checkin.server.domain.Shop) shop, title, description, (de.gmino.geobase.server.domain.ImageUrl) image, (de.gmino.geobase.server.domain.Duration) duration);
	}
