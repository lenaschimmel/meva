...
public class Checkin extends CheckinGen {
	...
	public Checkin(long id, boolean ready, Timestamp timestamp, Consumer consumer, Shop shop) {
		super(id, ready, (de.gmino.geobase.client.domain.Timestamp) timestamp, (de.gmino.checkin.client.domain.Consumer) consumer, (de.gmino.checkin.client.domain.Shop) shop);
	}
